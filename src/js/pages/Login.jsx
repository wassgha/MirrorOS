  ...
  componentDidMount() {
    this.props.socket.on('message', message => {
      if (message.detected === false) {
        $('.login').html(
          '<i class="material-icons">sentiment_neutral</i><br>I don\'t see you'
        )
      } else if (message.identity === 0) {
        $('.login').html(
          '<i class="material-icons">sentiment_dissatisfied</i><br>I don\'t know you'
        )
      } else {
        $('.login').html(
          '<i class="material-icons">sentiment_satisfied</i><br>Hello <b>' +
