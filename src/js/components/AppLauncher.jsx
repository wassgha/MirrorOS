      ...
      <div className="app-launcher">
        <div className="app-launcher-section">
          <button className="app-launcher-back-button">
            <i className="material-icons" onClick={this.closeAppLauncher}>
              arrow_back
            </i>
          </button>
          ...
          <div className="app-launcher-section-icons">
            <AppLauncherApp
              bgColor="red"
              logo="http://s.ytimg.com/yt/img/logos/youtube_logo_onecolor_againstblack-vflAZNyvx.png"
            />
            <AppLauncherApp bgColor="#3498db" icon="wb_sunny" />
            <AppLauncherApp
              bgColor="#262626"
              logo="http://techfaster.com/wp-content/uploads/2014/07/Uber-Logo.png"
            />
